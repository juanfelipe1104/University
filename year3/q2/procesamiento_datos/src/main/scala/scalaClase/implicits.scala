...
object implicits extends App {
  ...
  // 4. Pruebas
  private val distanciaEnMetros = new Longitud(1500)
  ...
  private val distanciaEnKm: Longitud = 2.5 // Se convierte automáticamente a Longitud en metros
  println(distanciaEnKm)  // Salida: 2500 metros

  private val distanciaEnMetros2: Double = distanciaEnMetros // Se convierte automáticamente a Double
