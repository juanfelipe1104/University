...
plt.loglog(
    h_values,
    [calc_error(calc_fd(f, x_0, h), f_real) for h in h_values],
    "o-",
    label="Forward",
)
plt.loglog(
    h_values,
    [calc_error(calc_bd(f, x_0, h), f_real) for h in h_values],
    "s-",
    label="Backward",
)
plt.loglog(
    h_values,
    [calc_error(calc_cd(f, x_0, h), f_real) for h in h_values],
    "^-",
    label="Centered",
)
plt.xlabel("h")
