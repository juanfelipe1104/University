...
\[
V(G^c)=V(G), \qquad A(G^c)=A(K_n)\setminus A(G).
\]
\begin{enumerate}
    \item Demuéstrese que $G=(V,A)$ y $G'=(V',A')$ son isomorfos si y sólo si sus complementarios son isomorfos.
    \item Encuéntrese un grafo con $5$ vértices que sea isomorfo a su complementario.
    \item ¿Existe un grafo con $3$ vértices que sea isomorfo a su complementario? ¿Y con $6$ vértices?
\end{enumerate}

\section*{Ejercicio 10}
Hállese el número de árboles distintos que se pueden formar con los vértices $\{1,2,\dots,n\}$ si
\begin{enumerate}
    \item $n=6$ y cuatro vértices tienen grado $2$;
    \item $n=5$ y exactamente tres vértices tienen grado $1$;
    \item $n=8$, dos de los vértices tienen grado $4$ y los seis restantes tienen grado $1$.
\end{enumerate}
...
Calcúlese el número de árboles recubridores distintos del grafo bipartito completo $K_{2,r}$. ¿Y del grafo bipartito completo $K_{3,r}$?
