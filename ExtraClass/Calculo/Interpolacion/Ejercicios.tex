...
\section*{Ejercicio 6}
Calcula \(\sqrt[3]{30}\) con un error menor que \(10^{-5}\) utilizando el desarrollo de Taylor adecuado.

\section*{Ejercicio 7}
Calcula \(\ln(1.2)\) con un error menor que \(10^{-5}\) utilizando el desarrollo de Taylor adecuado.
